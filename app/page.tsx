...
function fmtPosition(value: number, lat: boolean) {
  ...
  const abs = Math.abs(value); const degrees = Math.floor(abs); const minutes = (abs - degrees) * 60;
