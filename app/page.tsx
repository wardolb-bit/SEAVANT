...
export default function Home() {
  return <IdentityGate>{(identity) => <OperationsHome {...identity} />}</IdentityGate>;
}

function OperationsHome({ user, vessel: selectedVessel, vessels, selectVessel, signOut }: {
  ...
  return <main className="shell">
    ...
    <footer>SEAVANT ALPHA 0.6.1 · IDENTITY / MULTI-VESSEL</footer>
  </main>;
}
